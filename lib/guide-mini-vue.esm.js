...
function createRenderer(options) {
    const { createElement: hostCreateElement, patchProp: hostPatchProp, insert: hostInsert, setChildrenText: hostSetChildrenText, removeChild: hostRemoveChild, } = options;
    ...
    function mountText(v1, v2, container) {
